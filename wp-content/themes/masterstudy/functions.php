...
add_filter( 'bp_nouveau_enable', '__return_false' );
...
if ( is_admin() ) {
	...
	require_once $inc_path . '/admin/pro_plus_upgrade/pro_plus_upgrade.php';
	require_once $inc_path . '/admin/mailchimp-integration.php';
