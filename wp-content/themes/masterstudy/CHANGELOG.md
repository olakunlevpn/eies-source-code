## 4.8.140 - 2026-03-12
- **UPD** MasterStudy LMS Free plugin updated to version 3.7.18.
- **UPD** MasterStudy LMS Pro plugin updated to version 4.8.12.

## 4.8.139 - 2026-03-02
- **UPD** Updated the design of the Instructor and Student profile pages with a more modern interface and improved usability.
- **UPD** MasterStudy LMS Free updated to 3.7.17.
- **UPD**: MasterStudy LMS Pro updated to 4.8.11.

## 4.8.138 - 2026-02-19
- **FIXED** Resolved an issue where sidebars and page settings disappeared in the theme.
- **UPD** MasterStudy Free updated to version 3.7.16.
- **UPD** STM Configurations updated to version 4.6.22
- **UPD** MasterStudy Pro updated to version 4.8.10.

## 4.8.137 - 2026-02-10
- **FIXED** Resolved the _load_text_domain_just_in_time warning.
- **UPD** MasterStudy Free updated to version 3.7.15.
- **UPD** MasterStudy Pro updated to version 4.8.9.
- **UPD** Slider Revolution updated to version 6.7.41.

## 4.8.136 - 2026-01-28
- **FIXED** WPML language switcher appeared as plain text in the mobile menu
- **UPD** MasterStudy Free updated to version 3.7.13
- **UPD** MasterStudy Pro updated to version 4.8.8

## 4.8.135 - 2025-12-25
- **UPD** MasterStudy Free updated to version 3.7.9
- **UPD** MasterStudy Pro updated to version 4.8.7

## 4.8.134 - 2025-12-18
- **UPD** MasterStudy Free updated to version 3.7.7
- **UPD** MasterStudy Pro updated to version 4.8.6
- **FIXED** Minor bug fixes

## 4.8.133 - 2025-12-10
- **UPD** MasterStudy Free updated to version 3.7.6
- **UPD** MasterStudy Pro updated to version 4.8.5
- **FIXED** Address could not be edited via the WooCommerce account page when MasterStudy Theme was active

## 4.8.132 - 2025-12-04
- **UPD** MasterStudy Free updated to version 3.7.5
- **UPD** MasterStudy Pro updated to version 4.8.4
- **UPD** Compatibility with WordPress 6.9

## 4.8.131 - 2025-11-19
- **UPD** MasterStudy Free updated to version 3.7.3
- **UPD** MasterStudy Pro updated to version 4.8.3
- **UPD** MasterStudy Elementor Widgets updated to version 1.2.6
- **UPD** WPBakery updated to version 8.7.2

## 4.8.130 - 2025-11-12
- **UPD** MasterStudy Pro updated to version 4.8.2

## 4.8.129 - 2025-11-12
- **UPD** MasterStudy Pro updated to version 4.8.1

## 4.8.128 - 2025-11-10
- **UPD** MasterStudy Free updated to version 3.7.0
- **UPD** MasterStudy Pro updated to version 4.8.0

## 4.8.127 - 2025-11-04
- **FIXED**: Minor bug fixes.

## 4.8.126 - 2025-10-16
- **UPD** MasterStudy Free updated to version 3.6.26
- **UPD** MasterStudy Pro updated to version 4.7.20
- **UPD** WPBakery updated to version 8.7
## 4.8.125 - 2025-10-08
- **UPD** MasterStudy Free updated to version 3.6.25
- **UPD** MasterStudy Pro updated to version 4.7.19

## 4.8.124 - 2025-09-29
- **UPD** MasterStudy Free updated to version 3.6.24
- **UPD** MasterStudy Pro updated to version 4.7.18

## 4.8.123 - 2025-09-24
- **UPD** MasterStudy Free updated to version 3.6.23
- **UPD** MasterStudy Pro updated to version 4.7.17
- **UPD** WooCommerce templates updated

## 4.8.122 - 2025-09-23
- **FIXED**: Minor bug fixes.
- **UPD**: MasterStudy Elementor Widgets is updated to v1.2.5.
- **UPD**: MasterStudy Pro updated to version 4.7.16

## 4.8.121 - 2025-09-18
- **FIXED** The timer was not displayed on the Enrolled Courses page for courses with a time limit enabled
- **UPD**: MasterStudy Free updated to version 3.6.22
- **UPD**: Updated the Slider Revolution plugin to version 6.7.37

## 4.8.120 - 2025-08-20
- **UPD**: MasterStudy Free updated to version 3.6.19
- **UPD**: MasterStudy Pro updated to version 4.7.15

## 4.8.119 - 2025-08-13
- **UPD**: MasterStudy Free updated to version 3.6.18
- **UPD**: MasterStudy Pro updated to version 4.7.14
- **UPD**: Updated the WPBakery plugin to version 8.6.1

## 4.8.118 - 2025-08-07
- **UPD**: MasterStudy Free updated to version 3.6.17
- **UPD**: MasterStudy Pro updated to version 4.7.13

## 4.8.117 - 2025-07-30
- **UPD**: MasterStudy Free plugin to version 3.6.15
- **UPD**: MasterStudy Pro plugin to version 4.7.12
- **UPD**: WooCommerce templates updated
- **UPD**: Paid Memberships Pro templates updated

## 4.8.116 - 2025-07-24
- **UPD**: MasterStudy Free plugin to version 3.6.14
- **UPD**: MasterStudy Pro plugin to version 4.7.11

## 4.8.115 - 2025-07-16
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.7.10
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.6.12

## 4.8.114 - 2025-07-09
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.7.9
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.6.11
...
## 4.8.112 - 2025-07-02
- **FIXED**: Minor bugfixes
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.7.8.
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.6.10.

## 4.8.111 - 2025-06-25
- **UPD**: Updated WooCommerce templates to the latest version
- **UPD**: Updated the Slider Revolution plugin to version 6.7.34
- **UPD**: Updated the WPBakery plugin to version 8.5.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.7.7.
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.6.8.

## 4.8.110 - 2025-06-18
- **FIXED**: Removed warning messages when using the WPBakery Image Gallery widget
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.7.6.
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.6.6.

## 4.8.109 - 2025-06-11
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.7.5.
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.6.5.

## 4.8.108 - 2025-06-05
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.7.4.
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.6.4.

## 4.8.107 - 2025-06-04
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.7.3.
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.6.2.

## 4.8.106 - 2025-05-27
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.7.2.
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.6.1.

## 4.8.105 - 2025-05-22
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.7.1.

## 4.8.104 - 2025-05-21
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.6.0.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.7.0.

## 4.8.103 - 2025-05-07
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.32.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.21.

## 4.8.102 - 2025-05-02
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.31.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.20.
- **FIXED**: Minor bug fixes.

## 4.8.101 - 2025-04-29
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.30.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.19.
- **UPD**: WPBakery Page Builder updated - v8.4.1.
- **UPD**: RevSlider updated - v6.7.32.

## 4.8.100 - 2025-04-08
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.26.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.18.

## 4.8.99 - 2025-04-03
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.25.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.17.

## 4.8.98 - 2025-03-31
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.24.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.16.

## 4.8.97 - 2025-03-25
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.23.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.15.
- **FIXED:**: Fixed a bug on the single group page in Buddypress.
- **FIXED:**: Moved the BuddyPress menu in the student account above the LMS navigation menu.
- **FIXED:**: Corrected avatar sizes for users in BuddyPress Activity.
- **FIXED:**: Removed outdated LMS styles for BuddyPress.
- **FIXED:**: Fixed deprecated issues with the BuddyPress group avatar.
- **FIXED:**: Removed duplicate icons in selection lists for BuddyPress demo.
- **FIXED:**: Added a border to the comment text box in BuddyPress.
- **FIXED:**: Removed bold highlighting for the BuddyPress group avatar.

## 4.8.96 - 2025-03-19
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.22.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.14.
- **FIXED:**: Small bug fixes.

## 4.8.95 - 2025-03-13
- **FIXED:**: Improved error handling in the post comment form by adding clear, text-based error messages.
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.20.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.13.

## 4.8.94 - 2025-03-05
- **Enhancement**: Added compatibility with WooCommerce High-Performance Order Storage.
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.18.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.12.

## 4.8.93 - 2025-02-27
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.17.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.11.
- **UPD**: Updated Woocommerce templates

## 4.8.92 - 2025-02-13
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.15.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.10.

## 4.8.91 - 2025-02-06
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.14.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.9.

## 4.8.90 - 2025-01-30
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.12.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.8.
- **Enhancement**: Improved the design of the Profile Menu for better navigation.
- **FIXED:**: Fixed minor bugs in the Profile Menu.

## 4.8.89 - 2025-01-27
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.7.

## 4.8.88 - 2025-01-23
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.11.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.6.
- **UPD**: STM Configurations Plugin is updated to v 4.6.19.
- **FIXED:**: Fixed several bugs with the styles in the Private Instructor Elementor layout.
- **FIXED:**: Fixed alignment issues with the second-level menu in the RTL demo.

## 4.8.87 - 2025-01-16
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.10.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.5.
- **UPD**: STM Configurations Plugin is updated to v 4.6.18.
- **FIXED:**: Resolved an issue where the content of the first event was always displayed in the sidebar.
- **FIXED:**: Fixed an issue preventing edits to WooCommerce Product Categories.

## 4.8.86 - 2025-01-08
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.7.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.4.
- **UPD**: STM Configurations Plugin is updated to v 4.6.17.
- **FIXED:**: Resolved an issue where styles in Elementor were broken when creating News.
- **FIXED:**: Fixed a problem where a notification was incorrectly shown if a field was not filled in the Contact form.
- **FIXED:**: Corrected the Open in new window option, ensuring it functions properly in the Image Box widget.
- **FIXED:**: Fixed errors that appeared after updating the theme to support PHP 8.2.
- **FIXED:**: Addressed an error that appeared in the console on the Customizer page.
- **FIXED:**: Addressed issues in LMS settings where Course Card image sizes were not changing and Lazy Load didn't work without the theme and Post Type plugin.

## 4.8.85 - 2024-12-27
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.6.
- **FIXED:**: Small bug fixes.

## 4.8.84 - 2024-12-25
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.5.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.3.
- **UPD**: STM Configurations Plugin is updated to v 4.6.16.
- **UPD**: Added compatibility with Rev Slider 6.7.23.
- **UPD**: WPBakery Page Builder is updated to v8.1.
- **FIXED:**: Corrected error caused by the STM-Post-Type plugin on the WooCommerce categories page.
- **FIXED:**: Resolved issue where the "User Account Icon" and "Course Categories" toggles in Mobile Header settings remained visible on mobile devices.

## 4.8.83 - 2024-12-18
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.2.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.2.

## 4.8.82 - 2024-12-13
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.1.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.1.

## 4.8.81 - 2024-12-12
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.5.0.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.6.0.
- **FIXED:**: _load_textdomain_just_in_time issue fixed.

## 4.8.80 - 2024-12-09
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.4.17.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.5.9.

## 4.8.79 - 2024-11-28
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.4.15.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.5.8.

## 4.8.78 - 2024-11-25
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.4.14.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.5.7.

## 4.8.77 - 2024-11-20
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.4.13.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.5.6.
- **UPD**: WPBakery Page Builder is updated to v8.0.

## 4.8.76 - 2024-11-14
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.4.12.
- **UPD**: MasterStudy LMS Pro Plugin is updated to 4.5.5.

## 4.8.75 - 2024-11-07
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.4.10.
- **UPD**: MasterStudy LMS Pro Plugin is updated to 4.5.4.

## 4.8.74 - 2024-10-30
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.4.9.
- **UPD**: MasterStudy LMS Pro Plugin is updated to 4.5.3.

## 4.8.73 - 2024-10-21
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.4.7.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.5.2.

## 4.8.72 - 2024-10-18
- **UPD**: WPBakery Page Builder v 7.9.
- **Enhancement**: Improved the demo import process for a smoother experience.
- **Enhancement**: Updated templates in Paid Memberships Pro for better compatibility and performance.

## 4.8.71 - 2024-10-09
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.4.5.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.5.1.
- **UPD**: PMPro Templates Update.

## 4.8.70 - 2024-09-03
- **UPD**: MasterStudy LMS Free Plugin is updated to v3.4.0.
- **UPD**: MasterStudy LMS Pro Plugin is updated to v4.5.0.
- **UPD**: WPBakery Page Builder is updated to v7.8.
