...
update_option( 'revslider-code', 'OYLITE0000000005603B1EBE59708542' );
...
define('RS_TP_TOOLS',			'6.7.51'); //holds the version of the tp-tools script, load only the latest!
...
try{
	...
	add_action('plugins_loaded', array('RevSliderFront', 'set_sr7_engine_active'));
