	...
	<?php if ($rs_v7_selling) { ?>
		...
		--><div class="sr67-badge-right">
			...
			<?php } else { if ($rs_valid===true) {?>
				<a class="lilasmallbutton" href="https://www.sliderrevolution.com/sr7-upgrade-offer/" target="_blank" rel="noopener"><?php _e('Unlock SR7', 'revslider');?></a>
			 <?php } else {?>
	...
	<div id="plugin_update_row" class="plugin_inforow">
		...
		<div class="pli_left">
			...
			<div style="width:calc(50% - 5px);display:inline-block;vertical-align:top;">				
				...
				<?php } else { if ($rs_valid===true) {?>				
					<a class="purplebutton" id="unlockupgrade" href="https://www.sliderrevolution.com/sr7-upgrade-offer/" target="_blank" rel="noopener"><?php _e('Unlock SR7', 'revslider');?></a>
				<?php } else {?>
