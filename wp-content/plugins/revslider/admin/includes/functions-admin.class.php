...
class RevSliderFunctionsAdmin extends RevSliderFunctions {
	...
	public function get_javascript_multilanguage(){
		$lang = array(			
			...
			'areyousureupgradepluginsr7' => __('Do you want to start the SR7 upgrade process?', 'revslider'),
			...
			'updatetosr6' => __('Update SR6', 'revslider'),
			'upgradeToSR7' => __('Upgrade To SR7', 'revslider'),
			...
			'upgradepluginsr7' => __('Upgrade Plugin to SR7', 'revslider'),
			...
			'upgradingtakes' => __('Upgrading the Plugin may take a few moments.', 'revslider'),
