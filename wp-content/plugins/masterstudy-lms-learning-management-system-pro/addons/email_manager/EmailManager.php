...
class EmailManager implements Addon {
	...
	public function register( \MasterStudy\Lms\Plugin $plugin ): void {
		$plugin->load_file( __DIR__ . '/src/helpers.php' );
		$plugin->load_file( __DIR__ . '/src/hooks.php' );
		$plugin->load_file( __DIR__ . '/src/utils.php' );
		$plugin->load_file( __DIR__ . '/src/actions.php' );
		$plugin->load_file( __DIR__ . '/src/register-statuses.php' );
	}
}
