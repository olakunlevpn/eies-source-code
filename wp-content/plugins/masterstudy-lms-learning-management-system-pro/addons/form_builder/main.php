	...
	public function email_settings( $data ) {
		...
		if ( ! empty( $enterprise_fields ) ) {
			$data['stm_lms_enterprise']['vars'] = array_merge(
				$enterprise_fields,
				array(
					'date'      => esc_html__( 'Application Date', 'masterstudy-lms-learning-management-system-pro' ),
		...
		if ( ! empty( $become_instructor_fields ) ) {
			...
			$become_instructor_fields['site_url']            = esc_html__( 'Site URL', 'masterstudy-lms-learning-management-system-pro' );
			$become_instructor_fields['blog_name']           = esc_html__( 'Blog name', 'masterstudy-lms-learning-management-system-pro' );
